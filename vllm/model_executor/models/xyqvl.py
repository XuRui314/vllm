...
from mirage.XYQVL.configuration_qwen2_5_vl import (
    XYQVLConfig, XYQVLVisionConfig)
...
class Qwen2_5_VisionTransformer(nn.Module):
    ...
    def __init__(
        self,
        vision_config: XYQVLVisionConfig,
        norm_eps: float = 1e-6,
        quant_config: Optional[QuantizationConfig] = None,
        prefix: str = "",
    ) -> None:
...
class Qwen2_5_VLProcessingInfo(Qwen2VLProcessingInfo):
    ...
    def get_hf_config(self):
        return self.ctx.get_hf_config(XYQVLConfig)
...
class XYQForConditionalGeneration(nn.Module, SupportsMultiModal,
    ...
    def __init__(self, *, vllm_config: VllmConfig, prefix: str = ""):
        super().__init__()
        config: XYQVLConfig = vllm_config.model_config.hf_config
        ...
        self.language_model = init_vllm_registered_model(
            ...
            architectures=["XYQForCausalLM"],
        )

        self.drop_k = 3
        self.language_model.drop_k = self.drop_k
    ...
    def forward(
        ...
        **kwargs: object,
        ...
        # condition is only for v0 compatibility.
            ...
            # if input_ids.shape[0] not in [256, 128, 2, 1, 4, 136, 8, 144, 16, 152, 24, 160, 32, 168, 40, 176, 48, 184, 56, 192, 64, 200, 72, 208, 80, 216, 88, 120, 224, 96, 232, 104, 240, 112, 248, 163835]:
